        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-12">
            ...
            <Card className="p-8 hover:shadow-lg transition-all duration-300 bg-white/50 backdrop-blur-sm dark:bg-white/5">
              ...
              <p className="text-muted-foreground mb-4">
                Rooted Software • Feb 2023 - August 2023
              </p>
              <ul className="list-disc list-inside text-muted-foreground space-y-2">
                <li>
                  Troubleshot and resolved technical issues in Microsoft 365,
                  Azure, and Google Admin environments
                </li>
                <li>
                  Managed client communication and support, including in-person
                  and telephone assistance
                </li>
                <li>
                  Addressed security breaches and maintained network and
            ...
            <Card className="p-8 hover:shadow-lg transition-all duration-300 bg-white/50 backdrop-blur-sm dark:bg-white/5">
              ...
              <p className="text-muted-foreground mb-4">
                Self Employed • July 2018 - Present
              </p>
              <ul className="list-disc list-inside text-muted-foreground space-y-2">
                <li>
                  Founded and grew a yard work and house maintenance business at
                  age 14 clearly exercising a go-getter mentality
                </li>
                <li>
                  Expanded business to serve over 50 households with two
                  employees
                </li>
                <li>
                  Developed strong customer relations, time management, and
